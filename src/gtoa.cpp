...
Eigen::MatrixXd GTOA::initializationMatrix(int l, int u, int N, int D) {
...
Eigen::MatrixXd GTOA::sortByFitness(const Eigen::MatrixXd& m, double (*fitnessFunction)(const Eigen::VectorXd&))
{
...
returnValues GTOA::algorithm(int Tmax, int Population, int lowerBounds, int upperBounds, int Dimensions, double (*fitnessFunction)(const Eigen::VectorXd&))
{
